...
class Calculator:
    def __init__(self):
        ...
        for counter in range(1,5):
            self.buttons_frame.rowconfigure(counter, weight = 1)
            self.buttons_frame.columnconfigure(counter, weight = 1)
    ...
    def create_square_root_button(self):
        button = tk.Button(self.buttons_frame, text="x\u221ax", bg=OFF_WHITE, fg=LABEL_COLOR, font=DEFAULT_FONT_STYLE,
